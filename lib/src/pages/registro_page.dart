import 'package:bloc_formulario/src/models/users_models.dart';
import 'package:bloc_formulario/src/providers/usuario_provider.dart';
...
// al no definirle un alto ni año el container se expande a todo el ancho de la pantall
    ...
    return SingleChildScrollView(
      ...
      children: [
        ...
        TextButton(
          ...
          child: Text('¿ya tienes cuenta?inicar login'),
        ),
        SizedBox(
          height: 100.0,
        ),
  ...
  _registro(BuildContext context, LoginBloc? bloc) async {
    ...
    var resp = await usuarioProvider.creaUsuario(usuario);
    _loading = true;
